...
<body onload="getName('${username}');">
  <header class="header">
    <div class="header-container"  style="width:1200px;">
        ...
        <div class="header-login"style="margin-right:-10px;">
          <a href="User/login.action" class="open-green" id="login">登录</a>
          <a href="User/regist.action" class="open-vip" id="reg">注册</a>
        </div>
      </div>
  ...
  <script type="text/javascript" src="source/content-top-resource/js/index.js"></script>
