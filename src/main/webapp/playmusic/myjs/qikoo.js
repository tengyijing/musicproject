...
qikoo.dialog3 = function() {
	...
	var n = ['<div class="dialog3-content">', "<p style='font-size:16px;'>" + e + "</p>", "</div>", '<div class="dialog3-console clearfix_new">', '<a class="console-btn-confirm" href="/login">确定</a>',"</div>"].join(""),
