   ...
   <header class="header">
    <div class="header-container"  style="width:1200px;">
      ...
      <ul class="header-subNav" style="margin-top:20px;">
        ...
        <li><a href="huati.jsp" class="subNav-cur">话题</a></li>
  ...
  <div class="content-wrap"><!--内容-->
    <div class="content">
      ...
      <div class="content-block hot-content hidden-xs">
        ...
        <ul>
          <li class="large"><a href="javascript:scroll('list1');" target="_self"><img src="../../source/huati/images/list1.jpg" alt="">
      ...
      <div class="content-block new-content">
        ...
        <div class="row">
          <div class="news-list" id="list1">
            <div class="news-img col-xs-5 col-sm-5 col-md-4" style="margin-top:50px ;"> <img src="../../source/huati/images/rank1.jpg" alt="" width="220px" height="220px"> </div>
            <div class="news-info col-xs-7 col-sm-7 col-md-8">
              <dl>
                <dt style="font-size: 20px;"> 在那个平静时刻的奇妙:Cigarettes After Sex  </dt>
                <dd class="text"  style="line-height:30px">早在2008年，唱作人 Greg Gonzales 就已经在得克萨斯的家乡组建了 Cigarettes After Sex，并在2012年推出了乐队第一张作品，饱含浪漫情怀的四首歌EP《I》。此后不久 Greg Gonzales 便移居纽约，重组了乐队，并在过去两年间录制了这张在世界各地重新掀起 dream pop 热潮的《Cigarettes After Sex》。今年6月，随着这张同名专辑的发行，Cigarettes After Sex 成为了今年独立音乐圈炙手可热的最大惊喜。
 
伴着简约、舒缓却又充满画面感的配器编曲，主唱 Greg Gonzales 雌雄莫辨的阴柔嗓音，通过苦甜交织的低吟浅唱，讲述了一个个值得追忆的往日时光，乐队的音乐仿如他们队名一样，让听者感到惬意、温暖而平静。</dd>
              </dl>
            </div>
          </div>
          <div class="news-list" id="list2">
            <div class="news-img col-xs-5 col-sm-5 col-md-4" style="margin-top:50px ;"> <img src="../../source/huati/images/rank2.jpg" alt=""> </div>
            <div class="news-info col-xs-7 col-sm-7 col-md-8">
              <dl>
                <dt style="font-size: 20px;">  “认真地老去”的张希  </dt>
                <dd class="text" style="line-height:30px">通过与曹方合唱的单曲《认真地老去》，许多听众第一次认识了张希（豆瓣音乐人小站）。质朴走心路线的创作与演绎透露出这位民谣唱作人对音乐的虔诚态度。但在此之前，张希就师从著名音乐人小柯，后者许多作品都由他完成编曲，随后张希更为多位大牌流行音乐人的作品贡献了幕后的演奏与制作工作。今年7月，张希终于从幕后走到台前，他的首张个人专辑《认真地老去》在经过三年的悉心打磨之后终于浮出水面，新专辑的巡演也随即开始。8月12日，这个周六，第一波巡演即将迎来北京站的演出，音乐人好友曹方、满江等人也将作为嘉宾助阵。在现场见到他之前，来看看张希是如何回忆自己与音乐结缘的故事的。</dd>
              </dl>
            </div>
          </div>
          <div class="news-list" id="list3">
            <div class="news-img col-xs-5 col-sm-5 col-md-4" style="margin-top:50px ;"> <img src="../../source/huati/images/list3.jpg" alt=""> </div>
            <div class="news-info col-xs-7 col-sm-7 col-md-8">
              <dl>
...
已经无法考证谁是首唱这首歌的歌手了，甚至很可能没有留下初版的录音。一直到1930年代的大乐队时代，唱过的歌手应该无数，但最终留下记录的只有寥寥。翻遍手头的资料，只有一张大乐队时代的皇后Patti Page的录音。</dd>
              </dl>
            </div>
          </div>
          <div class="news-list" id="list4">
            <div class="news-img col-xs-5 col-sm-5 col-md-4" style="width:250px;height: 210px;"><img src="../../source/huati/images/rank4.jpg" alt="" style="margin-top:50px ;"> </div>
            <div class="news-info col-xs-7 col-sm-7 col-md-8">
              <dl>
                <dt style="font-size: 20px;">  给相识及未曾相识的人: </dt>
                <dd class="text" style="line-height:30px">    这两年，从对自己反复多次失望的状态中，写出了我这六七年最满意的曲子；从对现实失望的老人马中，和仍对未来有憧憬的新人马里，拉起一支队伍；从对我还有信心的那些还在坚持经营这行业的兄弟那得到了支持；甚至把身边做其它行业的那些＂无辜＂朋友那里，也找到了后盾。于是便有了这次即将完成的唱片，和即将开始的巡回演唱会。
人皆不惑，却撒娇耍赖，很多人不明：李泉想干嘛！无他，心有不舍，也有不甘，为音乐，为好伙伴，为自己。人应该还需要音乐吧？如果有需要，就要有人好好地做，真心实意地做。
    雨停了，该去棚里了。瑞士现在很清冷，我的心热着，相信还有很多人热着，也相信老去前应该做些热的事情。期待用音乐跟你见面的那天！</dd>
              </dl>
            </div>
          </div>
          <div class="news-list" id="list5">
            <div class="news-img col-xs-5 col-sm-5 col-md-4" style="margin-top: 60px;"> <img src="../../source/huati/images/list5.jpg" alt="">  </div>
            <div class="news-info col-xs-7 col-sm-7 col-md-8">
              <dl>
                <dt style="font-size: 20px;">  探索嘻哈先锋派之旅！</dt>
                <dd class="text" style="line-height:30px">
1994 年，在《闲谈》杂志（Mixmag）引入了「神游舞曲」（Trip Hop）这一概念后，许多音乐被自动地归入其中。兴盛一时的「酸性爵士」（Acid Jazz）已经日薄西山。其中英国厂牌 Mo Wax' 早期在「酸性爵士」风格上的尝试说不上成功。DJ Shadow 在前一年用一曲「In/Flux」拯救了 Mo Wax' 老板詹姆斯·拉维勒（James Lavalle）。当然，后者为完成 Mo Wax' 的复兴，除了积极地联系 DJ Shadow，还通过爵士杂志《无人可及》（Straight No Chaser）的编辑，保罗·布拉德肖（Paul Bradshaw）与远在日本的制作人 DJ Krush 取得了联系。『Krush』是 DJ Krush 个人第一张正式专辑，有饶舌艺人和女歌手在其中献声。「日式调酒」（Mixology）从九十年代开始在霓虹各地的小型俱乐部兴盛起来，『Krush』也正是如此，有着明显的「酸性爵士」的印记（因此由 Shadow Records 引入美国市场）。</dd>
              </dl>
            </div>
          </div>
        </div>
  ...
  <aside class="sidebar visible-lg" style="margin-top:50px;padding-left:100px;width:400px;"><!--右侧>992px显示-->
    ...
    <div class="sidebar-block recommend" style="margin-top: 40px;">
      <h2 class="title"><strong style="border-bottom: 2px solid red;color: red;font-weight: bold;">热门推荐</strong></h2>
      <ul>
        <li><a target="_blank" href="javascript:;"> <span class="thumb"><img src="../../source/huati/images/icon/icon.png" alt=""></span> <span class="text" style="font-weight: bold;margin-left:20px ;">陈奕迅：单车</span> <span class="text-muted" style="font-weight: bold;margin-left:20px ;">出自专辑：《Get a Life 》</span></a></li>
        <li><a target="_blank" href="javascript:;"> <span class="thumb"><img src="../../source/huati/images/icon/icon.png" alt=""></span> <span class="text" style="font-weight: bold;margin-left:20px ;">李健：风吹麦浪</span> <span class="text-muted" style="font-weight: bold;margin-left:20px ;">出自专辑：《想念你 》</span></a></li>
        <li><a target="_blank" href="javascript:;"> <span class="thumb"><img src="../../source/huati/images/icon/icon.png" alt=""></span> <span class="text" style="font-weight: bold;margin-left:20px ;">张国荣：似水流年</span> <span class="text-muted" style="font-weight: bold;margin-left:20px ;">出自专辑：《Salute 》</span></a></li>
        <li><a target="_blank" href="javascript:;"> <span class="thumb"><img src="../../source/huati/images/icon/icon.png" alt=""></span> <span class="text" style="font-weight: bold;margin-left:20px ;">金志文：远走高飞</span> <span class="text-muted" style="font-weight: bold;margin-left:20px ;">出自专辑：《Hello 1 》</span></a></li>
        <li><a target="_blank" href="javascript:;"> <span class="thumb"><img src="../../source/huati/images/icon/icon.png" alt=""></span> <span class="text" style="font-weight: bold;margin-left:20px ;">蔡健雅：双栖动物</span> <span class="text-muted" style="font-weight: bold;margin-left:20px ;">出自专辑：《双栖动物 》</span></a></li>
      </ul>
    </div>
    <div class="sidebar-block comment">
      <h2 class="title"><strong style="border-bottom: 2px solid red;color: red;font-weight: bold;">下期预告</strong></h2>
      <ul>
        <li data-toggle="tooltip" data-placement="top"><a target="_blank" href="javascript:;"><span class="face"><img src="../../source/huati/images/icon/icon.png" alt=""></span> <span class="text" style="margin-top: 20px;">被凝视的肉体与歌唱中的魂灵：海青专访</span></a></li>
        <li data-toggle="tooltip" data-placement="top"><a target="_blank" href="javascript:;"><span class="face"><img src="../../source/huati/images/icon/icon.png" alt=""></span> <span class="text" style="margin-top: 20px;">回顾 Liam Gallagher 的故事，会映出你的青春</span></a></li>
        <li data-toggle="tooltip" data-placement="top"><a target="_blank" href="javascript:;"><span class="face"><img src="../../source/huati/images/icon/icon.png" alt=""></span> <span class="text" style="margin-top: 20px;">华晨宇谈《齐天》：心中爱着你的美丽，又怎能嘴上装四大皆空</span></a></li>
        <li data-toggle="tooltip" data-placement="top"><a target="_blank" href="javascript:;"><span class="face"><img src="../../source/huati/images/icon/icon.png" alt=""></span> <span class="text" style="margin-top: 20px;">周笔畅专访：做音乐的时候需要有强迫症</span></a></li>
        <li data-toggle="tooltip" data-placement="top"><a target="_blank" href="javascript:;"><span class="face"><img src="../../source/huati/images/icon/icon.png" alt=""></span> <span class="text" style="margin-top: 20px;">一个励志故事：从资深邪典文艺老青年到宅系Hip Hop票友</span></a></li>
      </ul>
    </div>
  </aside>
  <!--/右侧>992px显示-->
