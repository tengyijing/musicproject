    ...
    <div class="pb-container-main pb-after-clear">
       ...
       <c:choose>
           <c:when test="${dynamic.id== null or dynamic.id=='0'}">
               <a class="mvList2" style="display: block;"> <img width="220" height="150"
                                                                src="source/playmusic/images/${dynamic.id}.jpg" alt=""/></a>
           </c:when>
           <c:otherwise>
        <a href="playMusic.do?id=${dynamic.musicId}&type=1" target='_new' class="mvList2" style="display: block;"> <img
                width="220" height="150" src="http://localhost:8080/images/${dynamic.musicId}.jpg"
				     ...
				     <span> <font>${dynamic.musicName}&#8211; ${dynamic.dynamicer}</font>
				      ...
				      <em>2pic4-12-31</em></font>
                        ...
                        <div class="con f-r" style="margin-right:50px;">
                            ...
                            <div style="margin-left:50px;margin-top:13px;font-size:17px;"><a
                                    href="getFriendSong.do?user=${dynamic.dynamicer}"
                                    style="display:inline">${dynamic.dynamicer }</a></div>
                            ...
                            <div class="commentAll" style="display:none;">
                                ...
                                <div class="reviewArea clearfix">
                                    <textarea class="content comment-input" placeholder="说点什么吧" onkeyup="keyUP(this)"
                                              hp2="${dynamic.dynamicId}"></textarea>
                                            ...
                                            <div class="comment-show-con-list pull-left clearfix">
                                                <div class="pl-text clearfix">
                                                    <a href="getFriendSong.do?user=${myReview.reviewer}"
                                                       ...
                                                       p4="${dynamic.dynamicId}">${myReview.reviewer}</a>
                                                ...
                                                <c:forEach items="${myReview.myRevert}" var="myRevert"
                                                    ...
                                                    <div class="all-pl-con" style="background-color:#EAEAEC">
                                                        <div class="pl-text hfpl-text clearfix">
                                                            <a href="#"
                                                               class="comment-size-name">${myRevert.reverter}</a>
                                                            <span class="my-pl-con">回复<span style="color:red">@<a
                                                                    style="color:#fa3b4a;display:inline;font-size:13px;"
                                                                    href="getFriendSong.do?user=${myRevert.toReverter}">${myRevert.toReverter}</a></span>&nbsp;${myRevert.revertContent}</span>
                                                        </div>
                                                        <div class="date-dz">
            ...
            <div class="commside">
                ...
                <div class="pb-iblock pb-fr pb-after-clear pb-main-side">
                    <a href="myMusic.do"><img class="pb-block" src="../../source/images/musicCircle.png"
                                              style="width:295px"/></a>
                    ...
                    <c:forEach items="${registList}" var="registList" varStatus="index4">
                        ...
                        <a href="getFriendSong.do?user=${registList.username}" class="tle pb-mt5"
                        ...
                        <a href="getFriendSong.do?user=${registList.username}"
                           class="but pb-clr1 pb-size-normal pb-mt15" style="background-color: #E3494B;">添加关注</a>
                    </c:forEach>
                </div>
                <!--右侧我要投稿公共部分-->
                ...
                <div class="sidewrap  pb-mt40">
                    ...
                    <div style="height:480px;overflow:hidden;" class="con pr">
                        ...
                        <div style="left:150px;height:150px;top:170px;" class="single">
                            <a title="证件照" href=""><img alt="" src="../../source/images/qing_10001_3c506bc67d.jpg"
                                                        style="width:145px;"/></a>
                        </div>
                        <div style="left:0px;height:150px;top:170px;" class="single">
                            <a title="" href=""><img alt="" src="../../source/images/essay_10001_0ba5781188.jpg"
                                                     style="width:145px;"/></a>
                        </div>
