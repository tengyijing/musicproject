		...
		<div class="header-top">
				...
				<form action="searchMusic.do" method="post" id="searchform">
					<input style="width: 170px;" type="text" class="text"
						...
						x-webkit-speech /> <span class="btn" id="vid" style="float: left;"><i><img
							style="margin-top: 6px;" src="source/images/video.png"></i></span> <span
						class="btn" onclick="search();"><i class="icon-sprite"></i></span>
				</form>
			...
			<div id="xianshi">
				<p style="margin-left: 5px; margin-top: 3px;">
					<a href="User/personalInfo"><img src="/source/images/person.png"></a>
				</p>
				<p style="margin-left: 4px; margin-top: 5px;">
					<a href="User/exit"><img src="/source/images/exit.png"></a>
				</p>
			</div>
...
<body onload="getName('${username}');">
  ...
  <section class="section_cont" style="margin-top:20px;">
   <!--轮播图 开始 -->
    <div class="main_banner">
        <div class="main_banner_bg"></div>
        <div class="main_banner_wrap">
            ...
            <div class="main_banner_box" id="m_box">
                ...
                <ul>
                    ...
                    <li id="imgCard2">
                        <a href=""><span style="opacity:0.4;" ></span></a>        
                        <img src="source/content-top-resource/main_banner/big0320150101183351.jpg" alt="">
                        <p>乐见大牌：灵魂段子手</p>
                    </li> 
                    <li id="imgCard3">
                        <a href=""><span style="opacity:0.4;"></span></a>      
                        <img src="source/content-top-resource/main_banner/big0420150101224343.jpg" alt="">
                        <p>王力宏四年心血结晶</p>
                    </li> 
                    <li id="imgCard4">
                        <a href=""><span style="opacity:0.4;"></span></a>      
                        <img src="source/content-top-resource/main_banner/big0720150102210934.jpg" alt="">
                        <p>《武媚》女神团美艳大比拼</p>
                    </li> 
                </ul>
                <!--火狐倒影图层-->
  ...
  <div class="main" id="newSong">
    <div class="main-inner">
      <div class="main-title">
        <h2 class="title"><font size=50px;>新歌首发</font></h2>
      ...
      <div class="main-slider tab-cont">
        <ul class="slider-wrapper">
          <li>
            <a href="playMusic.do?id=104&type=1" target='_new' class="img">
              <img src="source/images/cont/slider_img1.jpg" alt="#">
          ...
          <li>
            <a href="playMusic.do?id=20&type=1" target='_new' class="img">
              <img src="source/images/cont/slider_img2.jpg" alt="#">
              <span class="mask"></span>
              <i class="icon-play"></i>
            </a>
            <div class="info">
          ...
          <li>
            <a href="playMusic.do?id=35&type=1" target='_new' class="img">
              <img src="source/images/cont/slider_img3.jpg" alt="#">
              <span class="mask"></span>
              <i class="icon-play"></i>
            </a>
            <div class="info">
          ...
          <li>
            <a href="playMusic.do?id=58&type=1" target='_new' class="img">
              <img src="source/images/cont/slider_img4.jpg" alt="#">
              <span class="mask"></span>
              <i class="icon-play"></i>
            </a>
            <div class="info">
  ...
  <div class="main" id="mv">
    <div class="main-inner">
      <div class="main-title">
        <h2 class="title"><font size=50px;>热门歌曲</font></h2>
        <span class="line line-left"></span>
        <span class="line line-right"></span>
      </div>
      <a href="javascript:;" class="readAll">全部<i class="icon-sprite"></i></a>
      ...
      <ul class="mv-list tab-cont">
        <li class="item">
          <a href="playMusic.do?id=34&type=1" target='_new' class="img"><img src="source/images/cont/mv_img1.jpg" alt="#"><i class="icon-play"></i></a>
          <div class="info">
            <a href="playMusic.do?id=34&type=1" target='_new' class="title">最初的梦想</a>
            <a href="playMusic.do?id=34&type=1" target='_new' class="author">范玮琪</a>
            <span class="play-total"><i class="icon-sprite"></i>18万</span>
        ...
        <li class="item">
          <a href="playMusic.do?id=1&type=1" class="img"><img src="source/images/cont/mv_img2.jpg" alt="#"><i class="icon-play"></i></a>
          <div class="info">
            <a href="playMusic.do?id=1&type=1" class="title">漂洋过海来看你</a>
            <a href="playMusic.do?id=1&type=1" class="author">周深</a>
            <span class="play-total"><i class="icon-sprite"></i>11万</span>
          </div>
        </li>
        <li class="item">
          <a href="playMusic.do?id=79&type=1" target='_new' class="img"><img src="source/images/cont/mv_img3.jpg" alt="#"><i class="icon-play"></i></a>
          <div class="info">
            <a href="playMusic.do?id=79&type=1" target='_new' class="title">暧昧</a>
            <a href="playMusic.do?id=79&type=1" target='_new' class="author">薛之谦</a>
            <span class="play-total"><i class="icon-sprite"></i>28万</span>
        ...
        <li class="item">
          <a href="playMusic.do?id=95&type=1" target='_new' class="img"><img src="source/images/cont/mv_img4.jpg" alt="#"><i class="icon-play"></i></a>
          <div class="info">
            <a href="playMusic.do?id=95&type=1" target='_new' class="title">年少有你</a>
            <a href="playMusic.do?id=95&type=1" target='_new' class="author">李易峰</a>
            <span class="play-total"><i class="icon-sprite"></i>35万</span>
        ...
        <li class="item">
          <a href="playMusic.do?id=26&type=1" target='_new' class="img"><img src="source/images/cont/mv_img5.jpg" alt="#"><i class="icon-play"></i></a>
          <div class="info">
            <a href="playMusic.do?id=26&type=1" target='_new' class="title">追光者</a>
            <a href="playMusic.do?id=26&type=1" target='_new' class="author">岑宁儿</a>
            <span class="play-total"><i class="icon-sprite"></i>36万</span>
        ...
        <li class="item">
          <a href="playMusic.do?id=47&type=1" target='_new' class="img"><img src="source/images/cont/mv_img6.jpg" alt="#"><i class="icon-play"></i></a>
          <div class="info">
            <a href="playMusic.do?id=47&type=1" target='_new' class="title">我们的明天</a>
            <a href="playMusic.do?id=47&type=1" target='_new' class="author">鹿晗</a>
            <span class="play-total"><i class="icon-sprite"></i>19万</span>
        ...
        <li class="item">
          <a href="playMusic.do?id=41&type=1" target='_new' class="img"><img src="source/images/cont/mv_img7.jpg" alt="#"><i class="icon-play"></i></a>
          <div class="info">
            <a href="playMusic.do?id=41&type=1" target='_new' class="title">老街</a>
            <a href="playMusic.do?id=41&type=1" target='_new' class="author">李荣浩</a>
            <span class="play-total"><i class="icon-sprite"></i>29万</span>
        ...
        <li class="item">
          <a href="playMusic.do?id=72&type=1" target='_new' class="img"><img src="source/images/cont/mv_img8.jpg" alt="#"><i class="icon-play"></i></a>
          <div class="info">
            <a href="playMusic.do?id=72&type=1" target='_new' class="title">不再见</a>
            <a href="playMusic.do?id=72&type=1" target='_new' class="author">陈学冬</a>
            <span class="play-total"><i class="icon-sprite"></i>42万</span>
...
>>>>>>> cd52c7e1f6b3c12efc447c884b8b880c1a682dbc
