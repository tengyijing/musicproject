...
<header class="header">
    <div class="header-container" style="width:1200px;">
        <div class="header-top">
            ...
            <div id="name" style="display:none;padding-top:35px;"><a href="userInfo.do" style="cursor:pointer"><i
                    onmouseover="xianshi()" onmouseout="xiaoshi2()">${username}</i></a></div>
            <div id="xianshi">
                <p style="margin-left:5px;margin-top:3px;"><a href="userInfo.do"><img src="/source/images/个人.png"></a>
                </p>
...
<div class="main" id="mv">
    <div class="main-inner">
        ...
        <ul class="mv-list tab-cont">
            <li class="item">
                <a href="playMusic.do?id=34&type=1" target='_new' class="img"><img src="source/images/cont/mv_img1.jpg"
            ...
            <li class="item">
                <a href="playMusic.do?id=1&type=1" class="img"><img src="source/images/cont/mv_img2.jpg" alt="#"><i
                        class="icon-play"></i></a>
                <div class="info">
            ...
            <li class="item">
                <a href="playMusic.do?id=79&type=1" target='_new' class="img"><img src="source/images/cont/mv_img3.jpg"
                                                                                   alt="#"><i class="icon-play"></i></a>
                <div class="info">
            ...
            <li class="item">
                <a href="playMusic.do?id=95&type=1" target='_new' class="img"><img src="source/images/cont/mv_img4.jpg"
                                                                                   alt="#"><i class="icon-play"></i></a>
                <div class="info">
            ...
            <li class="item">
                <a href="playMusic.do?id=26&type=1" target='_new' class="img"><img src="source/images/cont/mv_img5.jpg"
                                                                                   alt="#"><i class="icon-play"></i></a>
                <div class="info">
            ...
            <li class="item">
                <a href="playMusic.do?id=47&type=1" target='_new' class="img"><img src="source/images/cont/mv_img6.jpg"
                                                                                   alt="#"><i class="icon-play"></i></a>
                <div class="info">
            ...
            <li class="item">
                <a href="playMusic.do?id=41&type=1" target='_new' class="img"><img src="source/images/cont/mv_img7.jpg"
                                                                                   alt="#"><i class="icon-play"></i></a>
                <div class="info">
            ...
            <li class="item">
                <a href="playMusic.do?id=72&type=1" target='_new' class="img"><img src="source/images/cont/mv_img8.jpg"
                                                                                   alt="#"><i class="icon-play"></i></a>
                <div class="info">
