						...
						<ul class="sb">
							<c:forEach items="${recommendedSongsList}" var="recommended"
								...
								<li><a href="${recommended.musicStr}" target='_new'> <img
										...
										class="attachment-220x125 wp-post-image" alt="mv_1x2_10" /> <strong>${recommended.musicName}</strong>
		...
		<div class="hot_singer_cont new_common">
			...
			<ul class="singer_list">
				<li><a href="?p=369" class="singerPhoto"> <img
					...
					style="text-decoration: none; color: #EF8F90; margin-left: 20px;">周杰伦</a></li>
				<li><a href="?p=357" class="singerPhoto"> <img
					...
					style="text-decoration: none; color: #EF8F90; margin-left: 20px;">林俊杰</a></li>
				<li><a href="?p=363" class="singerPhoto"> <img
					...
					style="text-decoration: none; color: #EF8F90; margin-left: 20px;">陈奕迅</a></li>
				<li><a href="?p=367" class="singerPhoto"> <img
					...
					style="text-decoration: none; color: #EF8F90; margin-left: 20px;">张杰</a></li>
				<li><a href="?p=360" class="singerPhoto"> <img
					...
					style="text-decoration: none; color: #EF8F90; margin-left: 20px;">邓紫棋</a></li>
				<li><a href="?p=345" class="singerPhoto"> <img
					...
					style="text-decoration: none; color: #EF8F90; margin-left: 20px;">许嵩</a></li>
