                ...
                <div class="form-group" id="uploadForm" enctype='multipart/form-data'>
                    ...
                    <div class="fileinput fileinput-new" data-provides="fileinput" id="exampleInputUpload"
                        ...
                        <div class="fileinput-new thumbnail"
                             style="width: 200px;height: auto;max-height:150px;border:1px solid #f0f0f0; ">
                            <img id='picImg' style="width: 190px;height: auto;max-height: 140px;padding:5px;"
                                 src="../../source/images/noimage.png" alt=""/>
                        </div>
                        ...
                        <a href="javascript:;" class="btn btn-warning fileinput-exists open-green"
                           style="width:65px;margin-top:10px;" data-dismiss="fileinput">移除</a>
                    </span>
                    </div>
...
<div class="listen" style="display:none;margin-left:5px;">
    <iframe frameborder=0 width=1300 height=580 marginheight=0 marginwidth=0 scrolling=no
            src="getlistening.do?userName=${username}"></iframe>
</div>
<!-- 听歌排行结束 -->
