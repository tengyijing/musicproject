...
<script type="text/javascript" src="../../source/js/jquery.i18n.properties-1.0.9.js" ></script>
<script type="text/javascript" src="../../source/js/jquery-ui-1.10.3.custom.js"></script>
<script type="text/javascript" src="../../source/js/jquery.validate.js"></script>
<script type="text/javascript" src="../../source/js/page_regist2.js?lang=zh"></script>
...
function checkUserNamePass(){
	...
	//var md5 = new MD5();
	$.ajax({
	    url : "logining.do", //(默认: 当前页地址) 发送请求的地址
...
<div class="dataEye"> 
	    ...
	    <a href="../../index.jsp"><img src="../../source/images/logo.png" ></a>
	    </div> 	
<div style="background:url(../../source/images/bg.jpg) no-repeat; background-size: cover; width:1345px;">
	<div class="loginbox registbox" style="padding-top:50px;margin-right:45px;">
		<div class="login-content reg-content" >
			...
			<div class="row" style="margin-left:25px;">
				...
				<input style="width:235px;margin-left:65px;" type="text" value="" class="input-text-user noPic input-click" name="username" id="username">
			</div>
			<div class="row">
				<label class="field">密    &nbsp;&nbsp;码：</label>
				<input style="width:235px; margin-left:65px;" type="password" value="" class="input-text-password noPic input-click" name="password" id="password">
			</div>
			<div style="float:left; margin-left:32px;">
			<input type="checkbox"/>
			<span style="color:blue; vertical-align:middle;">记住密码</span>                   
			</div>
			<div><a href="forgetPassword.jsp" style="float:right; margin-right:40px;text-decoration:none;">忘记密码？</a></div>
		...
		<div class="go-regist">
			没有帐号,请<a href="regist.jsp" class="link">注册</a>
		</div>
	</div>
</div>	
<div id="footer">
	<div class="dblock">
		<div class="inline-block1" style="padding-top:6px;"><img src="../../source/images/logo-b.png" width="75" height="50" ></div>
		<div class="inline-block copyright" style="padding-top:30px;">
			<a href="#"style="text-decoration:none">关于我们</a> | <a href="#"style="text-decoration:none">QQ</a> | <a href="#" style="text-decoration:none">隐私政策</a> | <a href="#" style="text-decoration:none">说明</a>
			<p> Copyright © 2018 LoveMusic</p>
			<p><a href="http://www.miitbeian.gov.cn" style="text-decoration:none">鲁ICP备18010745号</a></p>
		</div>
	</div>
</div>
</div>
