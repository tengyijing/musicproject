...
<script type="text/javascript"
	src="../../source/js/jquery.i18n.properties-1.0.9.js"></script>
<script type="text/javascript"
	src="../../source/js/jquery-ui-1.10.3.custom.js"></script>
<script type="text/javascript" src="../../source/js/jquery.validate.js"></script>
<script type="text/javascript"
	src="../../source/js/page_regist2.js?lang=zh"></script>
...
<body class="loginbody" onload="getCookie();">
	<div id="All-Content2">
		<div class="dataEye">
			...
			<div
				style="background: url(../../source/images/bg.jpg) no-repeat; background-size: cover; width: 1345px;">
