...
<script src="source/regist/pictureYanZheng/js/jquery-1.12.3.min.js"></script>
        	...
        	<div class="reg-box" id="verifyCheck" style="margin-top:20px;">
            	<div class="part1">                	
                    <div class="item col-xs-12">
                     ...
                     <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" class="txt03 f-r3 required" keycodes="email" tabindex="2" data-valid="isNonEmpty||isEmail||isEmailBindingYan" data-error="邮箱不能为空||邮箱格式不正确||邮箱已被绑定，请更换" id="email" /> 
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" class="txt03 f-r3 required" keycodes="tel" tabindex="3" data-valid="isNonEmpty||isPhone||isPhoneYan" data-error="手机号码不能为空||手机号码格式不正确||手机号已被绑定，请更换" maxlength="11" id="phone" /> 
                            <span class="ie8 icon-close close hide"></span>                           
                            <label class="icon-sucessfill blank hide"></label>
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="password" id="password" maxlength="20" class="txt03 f-r3 required" tabindex="4" style="ime-mode:disabled;" onpaste="return  false" autocomplete="off" data-valid="isNonEmpty||between:6-20||level:2" data-error="密码不能为空||密码长度6-20位||该密码太简单，有被盗风险，建议字母+数字的组合" /> 
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="password" maxlength="20" class="txt03 f-r3 required" tabindex="5" style="ime-mode:disabled;" onpaste="return  false" autocomplete="off" data-valid="isNonEmpty||between:6-16||isRepeat:password" data-error="密码不能为空||密码长度6-16位||两次密码输入不一致" id="rePassword" />
                            <span class="ie8 icon-close close hide" style="right:55px"></span>
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" maxlength="4" class="txt03 f-r3 f-fl required" tabindex="6" style="width:167px" id="randCode" data-valid="isNonEmpty||isRandCode" data-error="验证码不能为空||验证码错误" /> 
                            <span class="ie8 icon-close close hide"></span>
                                  <span id="idcode" style="margin-left:5px"></span> 
                            	  <script>
                                  $.idcode.setCode();
                                  //加载生成验证码方法
                                  function yanzheng(){
                            ...
                            <label class="focusa">看不清？<a href="javascript:;" class="c-blue" onclick="$.idcode.setCode()">换一张</a></label>   
                ...
                <div class="part2" style="display:none">
                    ...
                    <div class="item col-xs-12">
                        <span class="intelligent-label f-fl"><b class="ftx04">*</b>验证码：</span>    
                        <div class="f-fl item-ifo">
                            <input type="text" maxlength="6" id="verifyNo" class="txt03 f-r3 f-fl required" tabindex="7" style="width:167px" data-valid="isNonEmpty||isEmailYan" data-error="验证码不能为空||验证码错误" /> 
                           	<span class="btn btn-gray f-r3 f-ml5 f-size13" id="time_box" disabled style="width:97px;display:none;" onclick="sentEmail()">发送验证码</span>
                ...
                <div class="part4 text-center" style="display:none">
                    ...
                    <p class="c-666 f-mt30 f-mb50" id="low">页面将在 <strong id="times" class="f-size18">10</strong> 秒钟后，跳转到 <a href="login.jsp" class="c-blue">登录界面</a></p>
                </div>          
            </div>
        </div>
    </div>
