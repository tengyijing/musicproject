...
<script type="text/javascript" src="source/regist/js/forgetPassword.js"></script>
</head>
    	...
    	<div class="reg-box-pan display-inline">  
        	...
        	<div class="reg-box" id="verifyCheck" style="margin-top:20px;">
            	<div class="part1">                	
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" maxlength="20" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:3-20||isUname||isUserNameYan" data-error="用户名不能为空||用户名长度3-20位||只能输入中文、字母、数字、下划线，且以中文或字母开头||用户名不存在" id="adminNo" />                            <span class="ie8 icon-close close hide"></span>
                     ...
                     <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" class="txt03 f-r3 required" keycodes="tel" tabindex="3" data-valid="isNonEmpty||isPhone||isPhoneYan" data-error="手机号码不能为空||手机号码格式不正确||手机号码错误" maxlength="11" id="phone" /> 
                    ...
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" maxlength="7" id="verifyNo" class="txt03 f-r3 f-fl required" tabindex="7" style="width:167px" data-valid="isNonEmpty||isEmailYan" data-error="验证码不能为空||验证码错误" /> 
                           	<span class="btn btn-gray f-r3 f-ml5 f-size13" id="time_box" disabled style="width:97px;display:none;" onclick="sentPhone()">发送验证码</span>
                ...
                <div class="part3 text-center" style="display:none">
                    ...
                    <p class="c-666 f-mt30 f-mb50" id="low">页面将在 <strong id="times" class="f-size18">5</strong> 秒钟后，跳转到 <a href="login.jsp" class="c-blue">登录界面</a></p>
                </div>          
            </div>
        </div>
    </div>
