...
$(function(){
	...
	$(".start em").click(function(){
		...
		$(this).css({
			"background":'url("source/playmusic/css/images/T1X4JEFq8qXXXaYEA_-11-12.gif") no-repeat',
			"color":""
		});
...
function audioPlay(ev){
	$(".iplay").css("background",'url("source/playmusic/css/images/T1oHFEFwGeXXXYdLba-18-18.gif") 0 0');
